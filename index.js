...
// Export the headless module for Android Auto integration
const JWPlayerHeadless = require('./src/JWPlayerHeadless').default;
module.exports = Object.assign(JWPlayer, {
  JWPlayerHeadless,
  JWPlayerAdClients,
  JWPlayerAdEvents,
  JWPlayerState,
